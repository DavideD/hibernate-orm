...
public class EntityDelayedFetchImpl extends AbstractNonJoinedEntityFetch {
	...
	public DomainResultAssembler<?> createAssembler(
		...
		final Initializer entityInitializer = creationState.resolveInitializer(
				...
				() -> getEntityDelayedFetchInitializer(
						parentAccess,
						navigablePath,
	...
	protected EntityAssembler getEntityAssembler(Initializer entityInitializer) {
		return new EntityAssembler( getFetchedMapping().getJavaType(), entityInitializer.asEntityInitializer() );
	}

	protected Initializer getEntityDelayedFetchInitializer(FetchParentAccess parentAccess, NavigablePath navigablePath, ToOneAttributeMapping entityValuedModelPart, boolean selectByUniqueKey, DomainResultAssembler<?> resultAssembler) {
